            ...
            {projects.map((p, i) => (
              <Reveal key={p.title} delay={i * 0.1}>
                {darkMode ? (
                  ...
                  // Light Mode - React App Style Gradient Cards
                  <motion.div 
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            {skills.map((s, i) => (
              <Reveal key={s} delay={i * 0.03}>
                <motion.span 
                  className={`rounded border px-4 py-1.5 text-sm cursor-default transition-all ${
                    darkMode 
                      ? "border-gray-400 dark:border-gray-700 hover:border-yellow-400 hover:text-yellow-500" 
                      : "border-gray-400 hover:border-orange-400 hover:text-orange-500"
                  }`}
          ...
          <Reveal delay={0.1}>
            <div className="max-w-2xl mx-auto">
              ...
              >
                ...
                <input type="hidden" name="_next" value="https://personal-portfolio-ashen-theta-65.vercel.app/" />
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
                  ...
                  <motion.button
                    ...
                    className={`inline-flex items-center gap-3 rounded-lg border px-8 py-4 font-semibold transition-all hover:scale-105 hover:shadow-lg ${
                      darkMode 
                        ? "border-gray-600 hover:bg-gray-800" 
                        : "border-gray-300 hover:bg-white shadow-md"
                    }`}
